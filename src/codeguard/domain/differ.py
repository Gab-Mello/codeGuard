...
def diff_snapshots(baseline: Snapshot, current: Snapshot) -> list[FileChange]:
    ...
    actually changing. The result is sorted by relative path so the output
    is deterministic and easy to render in a table.
    """
